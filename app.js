...
INSTRUCCION: Analiza la efectividad de las rutas y el momentum. Decide cual de los numeros de las medidas es mas probable que caiga a continuaci�n.
...
"]/g, '').trim();
            ...
            n9El.innerText = pN9;
            n4El.innerText = pN4;
            if (analysisEl) analysisEl.innerText = `An�lisis basado en medidas: CW(${window.lastSignal?.targetCW}) vs CCW(${window.lastSignal?.targetCCW})`;
