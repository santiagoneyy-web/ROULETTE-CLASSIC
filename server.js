...
function buildAutoAiUserPrompt(context) {
    ...
    return [
        ...
        '',
        'GUIA DE PATRONES W/L (aplica sobre los strings PERF 8T):',
        ...
        '',
        'ESTRATEGIA DE BLOQUES Y TURBULENCIA (direcciones):',
        '- BLOQUES: Cuando las direcciones salen en grupos grandes (DER DER DER DER IZQ IZQ IZQ IZQ), la mesa esta en modo bloque. Por lo general SIGUE en bloques. Confia en la direccion dominante actual.',
        '- TURBULENCIA: Cuando las direcciones no forman bloques grandes y son patrones cortos tipo 2-1-2-2-1-2 (DER DER IZQ DER IZQ IZQ DER DER), la mesa esta en turbulencia. Aqui usa patrones W/L para leer.',
        '- CICLO BLOQUE-TURBULENCIA: Tipicamente hay una subida en bloque largo (DER DER DER DER DER), luego viene la turbulencia al final, y despues continua en bloque en la otra direccion (IZQ IZQ IZQ IZQ IZQ). La turbulencia es la transicion.',
        '- FAROL DE ZONA: A veces la zona dominante (ej: BIG BIG BIG) hace un salto corto a la otra (SMALL SMALL SMALL) y luego vuelve a la dominante (BIG BIG BIG). Es un farol, no un cambio real. Si el farol es de pocos tiros, la dominancia original se mantiene.',
        '',
        'ESTRATEGIA DE ZONAS:',
        '- Las zonas (BIG/SMALL) tambien salen en bloques: BIG BIG BIG BIG SMALL SMALL BIG BIG BIG.',
        '- Si hay dominancia clara en una zona, confia en ella hasta que aparezca un bloque real de la otra.',
        '- Un salto corto de 2-3 tiros a la otra zona puede ser farol. Un bloque de 4+ tiros ya es cambio real.',
        '',
        'MODOS DE DECISION:',
